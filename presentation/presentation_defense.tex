...
\begin{itemize}
  \item Error rate $= 18{,}2\%$ (91 ошибочный ответ из 500)
...
\smallskip
\textbf{H1b (порог).} Верхняя граница 95\,\% bootstrap-CI error rate лучшей модели $< 0{,}10$ (т.\,е.\ accuracy $> 90\%$).
...
\end{center}
\vspace{-0.5em}
{\small \textbf{Чемпион~— \texttt{train\_mixed\_500}:} error rate $0{,}6\%$ (3 ош. из 500, в т.\,ч.\ 2~$\rho_\varnothing$), Macro $F_1 = 0{,}996$. ER baseline → mixed: $18{,}2\% \to 0{,}6\%$ (×30). $\rho_\varnothing$: $6{,}8\% \to 0{,}4\%$.}
\end{frame}
...
\end{center}
\vspace{-0.6em}
{\small Синтетика: минимум error rate $2{,}2\%$ на 500, рост до $4{,}4\%$ на 908. \quad
500 mixed ($0{,}6\%$) $<$ 908 synthetic $<$ best $\sim$1500 synthetic run.}
\end{frame}
...
\end{center}
\vspace{-0.5em}
{\small Чисто синтетика прибавляет $+2{,}2\ldots +5{,}4$~п.п.\ к error rate на real; \texttt{train\_mixed\_500}~— минимум $+0{,}6$~п.п.\ (ER $1{,}2\%$).}
\end{frame}
...
error rate $= 5{,}4\%$, но Macro $F_1 = 0{,}631$.
...
%% =========================================================
%% 20. Bootstrap-CI error rate
%% =========================================================
\begin{frame}
\frametitle{Bootstrap-CI error rate на benchmark-combined}
\begin{center}
\includegraphics[width=0.85\linewidth,height=0.78\textheight,keepaspectratio]{pictures/accuracy_ci.png}
\end{center}
\vspace{-0.5em}
{\small H1b подтверждена: верхняя граница CI \texttt{train\_mixed\_500} $= 0{,}014 < 0{,}10$ (т.\,е.\ accuracy $> 90\%$).}
\end{frame}
...
\begin{description}
  \item[\textsc{RQ1.}] LoRA-дообучение снижает error rate с $18{,}2\%$ до $0{,}6\%$ (более чем в~$30$~раз); все различия значимы.
  \item[\textsc{RQ2.}] Зависимость немонотонна: при 50 примерах ER $= 5{,}4\%$, минимум $2{,}2\%$ на 500 синтетике, рост до $4{,}4\%$ на 908.
  \item[\textsc{RQ3.}] Тип данных решает: чисто синтетика прибавляет до $+5{,}4$~п.п.\ к error rate на real; mixed-стратегия~--- лишь $+0{,}6$~п.п.
